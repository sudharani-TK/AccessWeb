...
try {
	...
	extentTest.log(Status.PASS, 'Clicked on edit file path icon')
	WebUI.setText(findTestObject('Object Repository/FilesPage/textBx_FilePath'), location)
	extentTest.log(Status.PASS, 'Entered the location to navigate - '+location)
	...
	//	WebUI.delay(2)
		...
		extentTest.log(Status.PASS, 'Hit enter key ')
	...
	WebUI.click(findTestObject('Object Repository/FilesPage/GotoFoldericon'))
	//WebUI.delay(3)
	extentTest.log(Status.PASS, 'Clicked on edit file path icon again ')
	String navigatedLocation=WebUI.getAttribute(findTestObject('Object Repository/FilesPage/gotofoldertext'), 'value')
	extentTest.log(Status.PASS, 'Extracted the value from path text box ')

	if(navigatedLocation.equals(location))
	{
		extentTest.log(Status.PASS, 'Extracted value - '+navigatedLocation+' matched the entered value - '+location)
		
	}
	else
	{
		extentTest.log(Status.FAIL, 'Extracted value - '+navigatedLocation+' does not match the entered value - '+location)
	}
